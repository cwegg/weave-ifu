...
def ifu_cat(pkg_ifu_cat_from_xmls, tmpdir_factory):
    ...
    # weave_ifu_workflow.stage6.function_1
    # weave_ifu_workflow.stage6.function_2
    # ...
    # weave_ifu_workflow.stage6.function_n
...
def test_check_populated_ifu_fits_cat(ifu_cat, pkg_ifu_cat_from_xmls):
    ...
    assert weave_ifu_workflow.stage6.check_populated_ifu_fits_cat(pkg_ifu_cat_from_xmls,
                                                                  ifu_cat)
